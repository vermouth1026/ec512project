...
public partial class reviews : System.Web.UI.Page
{
    ...
    private void loadp(){
        ...
        if (3 * c_page <= total_num)
        {
            ...
            rcs1_0.Text = " " + "Total: " + score[3 * (c_page - 1)] + " ";
            rcs1_1.Text = " " + "Prof: " + scorep[3 * (c_page - 1)] + " ";
            rcs1_2.Text = " " + "Cont: " + scorec[3 * (c_page - 1)] + " ";
            rcs1_3.Text = " " + "Hard: " + scoreh[3 * (c_page - 1)] + " ";
            ...
            rcs2_0.Text = " " + "Total: " + score[3 * (c_page - 1) + 1] + " ";
            rcs2_1.Text = " " + "Prof: " + scorep[3 * (c_page - 1) + 1] + " ";
            rcs2_2.Text = " " + "Cont: " + scorec[3 * (c_page - 1) + 1] + " ";
            rcs2_3.Text = " " + "Hard: " + scoreh[3 * (c_page - 1) + 1] + " ";
            ...
            rcs3_0.Text = "Total" + score[3 * (c_page - 1)+2];
            rcs3_1.Text = "Prof" + scorep[3 * (c_page - 1)+2];
            rcs3_2.Text = "Cont" + scorec[3 * (c_page - 1)+2];
            rcs3_3.Text = "Hard" + scoreh[3 * (c_page - 1)+2];
